...
| **As of** | **13 June 2026** (= `data/tracker-state.yaml` `last_run`) |
...
- **Latest act:** First-wave RTS consultations closed (CDD + business relationships 8 May 2026; pecuniary sanctions 9 Mar 2026); group-wide RTS closed 15 Jun 2026; BWRA + ongoing-monitoring guidelines open. — [pipeline](docs/amla-pipeline.md) · [consultations hub](https://www.amla.europa.eu/policy/public-consultations_en)

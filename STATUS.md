...
- **Latest act:** First-wave RTS consultations closed (CDD + business relationships 8 May 2026; pecuniary sanctions 9 Mar 2026); group-wide RTS closed 15 Jun 2026; BWRA + ongoing-monitoring guidelines open. On **8 Jul 2026** the regulatory-instruments tracker moved **six mandates to "Final report published"** — pecuniary-sanctions RTS (Art 53(10) AMLD6, ahead of the 10 Jul deadline), the EPPO-reporting ITS (Art 81(1) AMLR / 41(2) AMLAR) and FIU-to-FIU ITS (Art 31(2) AMLD6), plus the two end-2025 RTS (risk profile Art 40(2), selection Art 12(7)) — and **two new consultations opened** (reporting-format ITS Art 69(3) AMLR; FIU cross-border-exchange RTS Art 31(3) AMLD6). AMLA **concluded the ongoing-monitoring guidelines public hearing** (Art 26(5) AMLR) on **2 Jul 2026** and, on **8 Jul 2026**, introduced a **common EU approach to enforcing AML/CFT rules** (harmonised supervisory enforcement of breaches; ties to the final pecuniary-sanctions RTS, Art 53(10) AMLD6). AMLA also held its **first conference** (9 Jun 2026, Frankfurt) and published **direct-supervision eligibility-reporting webinar** materials (10 Jun 2026), and an **advisory note on ML/TF risks as the MiCAR transitional period ends** (29 Jun 2026; no blanket de-risking of transferring CASP customers). On **1 Jul 2026** AMLA and the **EDPB** announced a joint Level-3 workstream — **Guidelines on information-sharing partnerships** (Art 75 AMLR; consultation expected H1 2027). — [pipeline](docs/amla-pipeline.md) · [consultations hub](https://www.amla.europa.eu/policy/public-consultations_en)
...
- [ ] **Retrieve final-report / draft text** for the index-listed instruments that never appeared on the consultations hub. As of 8 Jul 2026 the **EPPO-reporting ITS** (Art 81(1) AMLR / 41(2) AMLAR) and **FIU-to-FIU ITS** (Art 31(2) AMLD6) show **Final report published** — retrieve the *final-report* text and add `..._final.md` extract siblings; the **Home-Host RTS** (Art 46(4) AMLD6) is still **Consultation closed** with draft text pending. Register + transcribe once a PDF surfaces. — [pipeline](docs/amla-pipeline.md#additional-index-listed-instruments-regulatory-instruments-tracker-not-on-the-consultations-hub)

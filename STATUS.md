...
- [ ] **CCP RTS (amending Delegated Regulation (EU) 2018/1108) — Commission Delegated Regulation pending.** The regulatory-instruments tracker moved the draft RTS on central-contact-point appointment criteria (Art 45(9) AMLD) to *"To be adopted by the Commission and published in the OJEU"* (17 Aug 2026); the status-changing event is the Commission Delegated Regulation in the OJ, at which point register it and move it into the pipeline status table. — [pipeline](docs/amla-pipeline.md)

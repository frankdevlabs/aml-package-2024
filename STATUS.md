...
| **As of** | **24 September 2026** (= `data/tracker-state.yaml` `last_run`) |
...
- [x] **3 September 2026** — ongoing-monitoring guidelines (Art 26(5) AMLR) consultation **closed** (hub flip observed 24 Sep 2026); final GL to the Commission now the pending benchmark. — [pipeline](docs/amla-pipeline.md)
- [x] **20 September 2026** — reporting-format ITS (Art 69(3) AMLR) consultation **closed** (public hearing 9 Sep 2026; hub flip observed 24 Sep 2026); final ITS to the Commission now the pending benchmark. — [pipeline](docs/amla-pipeline.md)

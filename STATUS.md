...
- [ ] **September 2026** — EBA **reporting framework v4.4** taxonomy for AMLA's 2027 risk-assessment data collection (Art 12(7) AMLAR); the 2026 dedicated data collection (cut-off 31 Dec 2025) feeds the first selection process, which starts **no later than 1 July 2027**. — [pipeline](docs/amla-pipeline.md)

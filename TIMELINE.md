...
| 2026-09-03 | **NL min. Heinen (Financiën) answers Kamervragen** on the Albanian-resort / Dutch letterbox-firm reporting (Aanhangsel nr. 2923, kenmerk 2026Z13066): confirms the Iwt is expected to be **submitted to the Tweede Kamer before end-2026**, that NL **will use** a member-state option requiring **EDD for domicilieverleners & trust-service providers** but **declines** the option to lower the **UBO threshold to 15%** in high-risk situations, and that NL's negotiated **domicilieverlener registration duty** is now in the package | [`docs/netherlands.md`](docs/netherlands.md) · [register](sources/README.md) |

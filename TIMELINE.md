# Timeline — EU AML Package (AMLR / AMLA / AMLD6)

Sourced chronology. Adoption → AMLA stand-up → Level-2/3 pipeline → application. Newest events at the bottom of
each year. Forward-looking dates are AMLA/government **targets**, not completed events.

## 2024

| Date | Event | Source |
|---|---|---|
| 2024-05-31 | **AMLR, AMLA Regulation and AMLD6 adopted** (Reg (EU) 2024/1624, Reg (EU) 2024/1620, Dir (EU) 2024/1640) | [instruments](docs/instruments/) |
| 2024-06-19 | Published in **OJ L, 19.6.2024** | [AMLR ELI](https://eur-lex.europa.eu/eli/reg/2024/1624/oj/eng) |
| 2024-06-26 | **AMLA Regulation enters into force** (7 days after OJ) | [AMLA digest](docs/instruments/amla-2024-1620.md) |
| 2024-07-09 | **AMLR and AMLD6 enter into force** (20 days after OJ) | [AMLR digest](docs/instruments/amlr-2024-1624.md) |
| 2024-12-30 | Recast **Transfer of Funds Regulation (EU) 2023/1113** becomes applicable | [TFR digest](docs/instruments/tfr-2023-1113.md) |

## 2025

| Date | Event | Source |
|---|---|---|
| 2025-01-21 | Council appoints **Bruna Szego** as AMLA Chair | [AMLA digest](docs/instruments/amla-2024-1620.md) |
| 2025-06-10 | Eerste Kamer adopts **Wet plan van aanpak witwassen** (cash limit, dossier 36.228) | [`docs/netherlands.md`](docs/netherlands.md) |
...
| Date | Event | Source |
|---|---|---|
| 2026-01-01 | **NL €3,000 cash-payment ban for goods** in force | [`docs/netherlands.md`](docs/netherlands.md) |
| 2026-02-04 | AMLA publishes **SPD 2026–2028** + Annex XI | [register](sources/README.md) |
| 2026-02-09 | AMLA opens first-wave RTS consultations — **CDD (Art 28(1))**, **business relationships (Art 19(9))**, **pecuniary sanctions (Art 53(10) AMLD6)** | [pipeline](docs/amla-pipeline.md) |
| 2026-03-09 | Pecuniary-sanctions RTS consultation **closes** | [pipeline](docs/amla-pipeline.md) |
| 2026-03-24 | **First public hearing** (1600+ stakeholders) on CDD + business-relationships RTS | [AMLA](https://www.amla.europa.eu/amla-concludes-first-public-hearing-draft-regulatory-technical-standards_en) |
...
| 2026-05-07 | NL **Iwt** adviesaanvraag formally lodged with the **Raad van State** (WGK027204; advice not yet uitgebracht) | [`docs/netherlands.md`](docs/netherlands.md) |
...
| 2026-08-17 | AMLA **regulatory-instruments tracker** advances the **CCP RTS** — draft RTS amending **Delegated Regulation (EU) 2018/1108** (criteria for appointing a **central contact point**; Art 45(9) AMLD) to status **"To be adopted by the Commission and published in the OJEU"**: a final draft RTS submitted to the Commission, awaiting a Commission Delegated Regulation in the OJ. Distinct from the 6 Aug CCP *survey*; index "Final report published" count unchanged at 7; no operative text on the index | [pipeline](docs/amla-pipeline.md#additional-index-listed-instruments-regulatory-instruments-tracker-not-on-the-consultations-hub) · [triage #83](docs/triage/2026-08-17-issue-83.md) |
...
| 2029-07-10 | AMLR football-agents/clubs sub-set applies; AMLD6 Art 18 deadline |

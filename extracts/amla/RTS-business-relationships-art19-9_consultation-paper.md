# Draft RTS — business relationships, occasional & linked transactions and lower thresholds

> Source: **Draft RTS — business relationships, occasional & linked transactions and lower thresholds** (AMLA), legal basis **Article 19(9) AMLR** — draft RTS out for public consultation
> (9 February 2026 – 8 May 2026; Closed — final to Commission by 10 July 2026). Interinstitutional context: EU AML Package (AMLR/AMLA/AMLD6).
...
> [`../../sources/amla/RTS-business-relationships-art19-9_consultation-paper_2026-02-09.pdf`](../../sources/amla/RTS-business-relationships-art19-9_consultation-paper_2026-02-09.pdf) and the [AMLA consultation page](https://www.amla.europa.eu/policy/public-consultations/consultation-draft-rts-criteria-identifying-business-relationships-occasional-and-linked_en).
...
(1)   Regulation (EU) 2024/1624 aims for harmonisation of the measures to be put in place
...
points (c), (d), (e) and (f) of Regulation (EU) 2024/1624 provide a list of four situations
in which the application of customer due diligence measures is required regardless of
the value of the transaction.
(2)   All obliged entities are required to have internal policies and procedures in place to
ensure compliance with the obligations regarding customer due diligence in Chapter
III of Regulation (EU) 2024/1624. These internal policies and procedures should be
...
(3)   Identifying linked transactions is, among other, relevant for ensuring that the
...
Article 3(3), points (i) and (j) of Regulation (EU) 2024/1624. Although there can be
...
(4)   Business relationships and linked transactions are defined in respectively Article 2(1),
...
(5)   Business relationships and occasional transactions are mutually exclusive. To clarify
...
transaction.
(6)   The Union’s AML/CFT framework applies to a wide variety of obliged entities. Some
...
fees.
(7)   An element of the definition of a business relationship is the expectation, or subsequent
...
(8)   The second paragraph of Article 2 of this Regulation provides two criteria that should
...
(iii) of Regulation (EU) 2024/1624, provide this service at different intervals, which
...
a customer.
(9)   The third paragraph of Article 2 of this Regulation contains specific criteria for
...
(10) Most transactions concerning football clubs will in practice fall within the definition
...
(11) Regulation (EU) 2024/1624 stipulates that transactions should be linked if two or more
...
(12) Two or more transactions performed by different customers of the obliged entity might
...
(13) Customers operating in concert should at least be taken into account by obliged entities
...
(14) Transactions pertaining to the same purchase should at least be considered as a
...
(15) Transactions that share common characteristics can mean a circular movement of
...
linked transactions.
(16) Another criterion that should be taken into account when considering the element of
...
(17) When considering the element of a specific period, obliged entities should at least take
...
and the services they offer. Therefore, it should be considered on the basis of the nature
...
### <a id="article-1"></a>Article 1 — Definitions
...
### <a id="article-2"></a>Article 2 — Criteria for distinguishing a business relationship from an occasional
...
2. Obliged entities as defined in Article 3(3), points (a) to (d), and (l) of Regulation (EU)
...
### <a id="article-3"></a>Article 3 — Criteria for identifying linked transactions
...
(i)     customers are family members;

(ii)    customers are business partners;
...
(i)     based on information available to the obliged entity, transactions

share common characteristics;

(ii)    transactions with an identical or similar origin and destination according to
...
(iii)   transactions with an identical or similar origin according to the definition of
...
3. In addition to the criteria set out in paragraph 1, point (c), providers of gambling services
...
### <a id="article-4"></a>Article 4 — Entry into force and application
...
3, points (3)(n) and (o), of Regulation (EU) 2024/1624, to which it shall apply from 10 July
2029.

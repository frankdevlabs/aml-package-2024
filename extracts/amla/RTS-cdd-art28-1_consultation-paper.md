# Draft RTS — customer due diligence

> **Working transcription — not an official text.** Source: AMLA consultation paper *Draft RTS — customer due diligence*
> (Regulatory Technical Standards (RTS)), legal basis **Article 28(1) AMLR**. Consultation opened **9 February 2026**, closes **8 May 2026** — status: Closed — final to Commission by 10 July 2026.
> This is the operative draft instrument extracted (via `pdftotext`) from the committed consultation paper
> [`../../sources/amla/RTS-CDD-art28-1_consultation-paper_2026-02-09.pdf`](../../sources/amla/RTS-CDD-art28-1_consultation-paper_2026-02-09.pdf); verify against that PDF and the
> [AMLA consultation page](https://www.amla.europa.eu/policy/public-consultations/consultation-draft-rts-customer-due-diligence_en) before relying on it. Background, questions and the cost-benefit annex of
...
```text
   ...
   (5)     Obtaining data and documents from independent and reliable sources is key to ensuring
           ...
           version of the constitutive documents establishing the legal entity or legal arrangement,
   ...
   (11)    When collecting information on the identity of SMOs in line with Article 22(2), second
           ...
           the registered office of the legal entity instead of the residential address and country of
   ...
   (23)    Article 19(7) of Regulation (EU) 2024/1624 provides for a list of four conditions on the
       ...
       (24)    The use of attributes of means of electronic identification and qualified trust services for
 ...
 ii)          In relation to the name of a legal entity as referred to in Article 22(1), point (b)(i), and other
   ...
   6.    Electronic identification means, as described in Article 7(1), shall be permitted to verify the
   ...
   (d)   the accuracy of the source, based on whether the information or data provided had to undergo
   ...
   2.    For the purposes of the first paragraph and in situations where the customer’s ownership and
         ...
         (a)     a description of the ownership and control structure, including the legal entities and/or
                ...
                beneficial owners and relevant for understanding the ownership and control structure;
                and
         (b)    where applicable:
   ...
   2.    In the case of complex corporate structures as referred to in paragraph 1, obliged entities
   ...
   (a)     in relation to the purpose and economic rationale of the occasional transaction or business
         ...
         iv.    whether the customer has additional business relationships with the obliged entity or,
   ...
   1.       To identify a politically exposed person or a family member 2, or person known to be a close
   ...
   1.    For the purposes of Article 34(4), point (b), of Regulation (EU) 2024/1624, obliged entities
   ...
   For the purposes of Article 34(4), point (d), of Regulation (EU) 2024/1624, obliged entities shall
   ...
   (b)   in case of a match, the information under point (a) shall be checked against all available due
         ...
         them, including public sources of information, such as registers of owned and controlled
   ...
   (h)   the extent to which the payment instrument is available through direct channels which may
         ...
         to-face distributions, possess adequate safeguards, including electronic signatures, and anti-
...
(a) for a natural person    (i) all names and surnames                      •   family_name
                                                                            •   given_name
                            (ii) place and full date of birth               •   birth_date
                                                                            •   birth_place
                            (iii) nationalities, or statelessness and       •   nationality
                            refugee or subsidiary protection status         •   Other existing attributes covering
                            where applicable, and national                      statelessness and refugee or subsidiary
                            identification number, where applicable             protection status (where applicable)
                                                                            •   personal_administrative_number
                                                                                (where applicable)
                            (iv) the usual place of residence or, if        •   resident_country
                            there is no fixed residential address with      •   resident_state
                            legitimate residence in the Union, the          •   resident_city
                            postal address at which the natural person      •   resident_postal_code
                            can be reached and, where available the         •   resident_street
                            tax identification number                       •   resident_house_number
                                                                            •   resident_address
                                                                            •   Other existing attributes covering the
                                                                                tax identification code (where
                                                                                available)
(b) for a legal entity      (i) legal form and name of the legal entity     •   current legal name
                                                                            ...
                                                                            •   a unique identifier constructed by
                                                                                ...
                                                                                time
                            (ii) address of the registered or official      •   current address
                            office and, if different, the principal place   •   Other existing attributes covering
                            of business, and the country of                     additional addresses
                            establishment                                   •   Other existing attributes covering the
                                                                                country of creation
                            (iii) the names of the legal representatives    •   Other existing attributes covering the
                            of the legal entity as well as, where               names of the legal representatives of
                            available, the registration number, tax             the legal entity
                            identification number and Legal Entity          •   Legal Entity Identifier (LEI) (where
                            Identifier                                          available)
                                                                            •   VAT registration number or tax
                                                                                reference number (where available)
                                                                            •   Other existing attributes covering the
                                                                                registration number (where available)
                            (iv) the names of persons holding shares        •   Other existing attributes covering the
                            or a directorship position in nominee               names of persons holding shares or a

         Based on Commission Implementing Regulation (EU) 2024/2977 of 28 November 2024 laying down rules for the
       ...
       identification data and electronic attestations of attributes issued to European Digital Identity Wallets
                       form, including reference to their status as   directorship position in nominee form,
                       nominee shareholders or directors              including reference to their status as
